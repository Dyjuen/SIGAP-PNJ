...
class KegiatanSeeder extends AbstractSeed
{
    public function run(): void
    {
        ...
        // Approval flow for Kegiatan 1 (with new approval_level and Wadir2)
        $this->table('t_kegiatan_approval')->insert([
            // Level 1: PPK
            [
                'kegiatan_id' => 1,
                'approver_user_id' => 4, // Assuming user ID for PPK
                'approval_level' => 'PPK',
                'status' => 'Disetujui',
                'catatan' => 'OK, laksanakan.'
            ],
            // Level 2: Wadir2
            [
                'kegiatan_id' => 1,
                'approver_user_id' => 5, // Assuming user ID for Wadir2
                'approval_level' => 'Wadir2', // Changed from 'Wadir' to 'Wadir2'
                'status' => 'Aktif', // 'Aktif' for Wadir2 based on the scenario
                'catatan' => null
            ],
            // Level 3: Bendahara-Cair
            [
                'kegiatan_id' => 1,
                'approver_user_id' => null, // No approver yet
                'approval_level' => 'Bendahara-Cair',
                'status' => 'Menunggu',
                'catatan' => null
            ],
            // Level 4: Bendahara-LPJ
            [
                'kegiatan_id' => 1,
                'approver_user_id' => null, // No approver yet
