  ...
  <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item" id="">
        <a href="/dashboard" class="menu-link gap-2">
      ...
      <li class="menu-item">
        ...
        <ul class="menu-submenu">
          <li class="menu-item">
            <a href="/usulan-kak" class="menu-link gap-2">
          ...
          <li class="menu-item">
            <a href="/monitoring-usulan" class="menu-link gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-circle"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
      ...
      <li class="menu-item">
        ...
        <ul class="menu-submenu">
          <li class="menu-item">
            <a href="/mengajukan-kegiatan" class="menu-link gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-circle"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
              <div data-i18n="Mengajukan Kegiatan">Mengajukan Kegiatan</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="/monitoring-kegiatan" class="menu-link gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-circle"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
              <div data-i18n="Monitoring Kegiatan">Monitoring Kegiatan</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="/pengajuan-lpj" class="menu-link gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-circle"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
      ...
      <!-- Riwayat -->
      <li class="menu-item">
        <a href="/riwayat" class="menu-link gap-2">
      ...
      <!-- Pengaturan -->
      <li class="menu-item">
        <a href="/pengaturan" class="menu-link gap-2">
