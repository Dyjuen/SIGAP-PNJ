...
<section id="landingRoles" class="section-py py-20 px-4 relative overflow-hidden">
  ...
  <div class="container mx-auto relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-6">
      ...
      <!-- Role 1: Pengusul -->
      <div class="feature-card group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:bg-cyan-50/50 hover:border-cyan-200 hover:-translate-y-1" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="100">
      ...
      <!-- Role 2: Verifikator -->
      <div class="feature-card group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:bg-cyan-50/50 hover:border-cyan-200 hover:-translate-y-1" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200">
        <div class="w-16 h-16 bg-cyan-100 rounded-xl flex items-center justify-center mb-6 mx-auto group-hover:scale-105 transition-transform duration-300">
          <svg class="w-8 h-8 text-[#33C8DA]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <!-- Role 3: WD2 & PPK -->
      <div class="feature-card group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:bg-cyan-50/50 hover:border-cyan-200 hover:-translate-y-1" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
        <div class="w-16 h-16 bg-cyan-100 rounded-xl flex items-center justify-center mb-6 mx-auto group-hover:scale-105 transition-transform duration-300">
          <svg class="w-8 h-8 text-[#33C8DA]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
      ...
      <!-- Role 4: Bendahara -->
      <div class="feature-card group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:bg-cyan-50/50 hover:border-cyan-200 hover:-translate-y-1" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="400">
        <div class="w-16 h-16 bg-cyan-100 rounded-xl flex items-center justify-center mb-6 mx-auto group-hover:scale-105 transition-transform duration-300">
          <svg class="w-8 h-8 text-[#33C8DA]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <!-- Role 5: Rektorat -->
      <div class="feature-card group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:bg-cyan-50/50 hover:border-cyan-200 hover:-translate-y-1" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="500">
        <div class="w-16 h-16 bg-cyan-100 rounded-xl flex items-center justify-center mb-6 mx-auto group-hover:scale-105 transition-transform duration-300">
          <svg class="w-8 h-8 text-[#33C8DA]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
