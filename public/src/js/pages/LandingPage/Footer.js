export function createFooter() {
  const footerHTML = `
    <footer class="bg-[#2BA9B8] text-white rounded-t-3xl flex flex-col w-full">
      <div class="py-12 px-6 md:px-12 lg:px-20 xl:px-32 2xl:px-48 w-full max-w-[1600px] mx-auto">
        <div class="flex flex-col lg:flex-row items-start justify-between gap-10">
          ...
          <div class="flex flex-col w-full lg:w-2/5 lg:border-r lg:border-white/20 lg:pr-10">
            <a href="/" class="flex items-center gap-3 mb-4 group">
              <img src="/assets/img/logo/logo-white.svg" alt="SIGAP Logo" class="h-9 w-auto transition-transform duration-300 group-hover:scale-105">
              <span class="font-bold text-xl tracking-wide">SIGAP</span>
            </a>
            <p class="text-white/90 text-sm leading-relaxed">Sistem Informasi Pengajuan KAK & LPJ</p>
            <p class="text-white/70 text-sm leading-relaxed mt-3">Membantu digitalisasi proses administrasi kegiatan kampus secara cepat, transparan, dan efisien.</p>
          </div>

          <!-- Sections -->
          <div class="w-full lg:w-auto">
            <h4 class="font-semibold text-sm tracking-wider mb-5 text-white/90">SECTIONS</h4>
            <nav class="flex flex-wrap gap-x-6 gap-y-3">
              ...
              <a href="#landingRoles" class="footer-link">Roles</a>
          ...
          <!-- Contact -->
          <div class="w-full lg:w-auto">
            <h4 class="font-semibold text-sm tracking-wider mb-5 text-white/90">HUBUNGI KAMI</h4>
      ...
      <div class="bg-[#267A84] py-4 w-full">
        <div class="px-6 md:px-12 lg:px-20 xl:px-32 2xl:px-48 max-w-[1600px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
        <span class="text-sm text-white/80 text-center sm:text-left">© 2025 SIGAP PNJ - Sistem Informasi Pengajuan KAK & LPJ</span>
